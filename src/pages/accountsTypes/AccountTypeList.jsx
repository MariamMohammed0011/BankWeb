...
if (loading) {
  return (
    <Box textAlign="center" mt={10} ml={15}>
      <Lottie
        animationData={loadingAnimation}  // ملف JSON للأنيميشن
        style={{ width: 180, height: 180 }}  // حجم الأنيميشن
      />
    </Box>
  );
}
...
<Box sx={{ my: 1 }}>
  ...
  <LinearProgress
    variant="determinate"
    value={item.annualInterestRate} // نسبة الفائدة
    sx={{ height: 10, borderRadius: 5, bgcolor: "#e0e0e0", "& .MuiLinearProgress-bar": { bgcolor: "#1976d2" } }}
  />
</Box>
